...
const AddCarts = () => {
    return (
        <>
            <ModalsContainer>
                <div className="modal fade" id="edit_cart_modal" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog modal-fullscreen">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title flex-fill" id="exampleModalLabel">جزئیات سبد خرید</h5>
                                ...
                                <div className="container">
                                    <div className="row my-3 justify-content-center">
                                        <div className="col-12 col-md-4 col-lg-3 my-1">
                                            <input type="text" className="form-control" list="customer_list"
                                        ...
                                        <div className="col-12 col-md-4 col-lg-2 my-1">
                                            <input type="text" className="form-control" list="product_list"
                                    ...
                                    <i className="fas fa-times text-danger hoverable_text pointer mx-1 has_tooltip"
                                       title="حذف محصول از سبد" data-bs-placement="top"></i>
                                    محصول شماره 1
                                    ( 100هزار تومان)
                                    ( گارانتی فلان)
                                    ...
                                    <i className="fas fa-circle mx-1" style={{color: ' #ec1010'}}></i>
                                        ...
                                        <div className="col-6">
                                            <div className="input-group my-3 dir_ltr">
                                            <span
                                                className="input-group-text justify-content-center w-75">200,000 تومان</span>
