...
const AddQuestions = () => {
    return (
        <>
            <ModalsContainer>
                <div className="modal fade" id="add_question_modal" tabIndex="-1" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title flex-fill" id="exampleModalLabel">افزودن سوال</h5>
                                    ...
                                    <div className="row justify-content-center">
                                        <div
                                            ...
                                            <label className="form-check-label pointer"
                                                   htmlFor="flexSwitchCheckDefault">سوال</label>
                                            <input className="form-check-input pointer mx-3" type="checkbox"
                                                   id="flexSwitchCheckDefault"/>
                                            <label className="form-check-label pointer"
                                                   htmlFor="flexSwitchCheckDefault">پاسخ</label>
                                        </div>
                                        <div className="col-12">
                                            <div className="input-group my-3 dir_ltr">
                                                <textarea rows="5" className="form-control"></textarea>
                                                <span
                                                    className="input-group-text w_8rem justify-content-center">متن سوال</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-12">
                                            <div className="input-group my-2 dir_ltr">
                                                <input type="text" className="form-control"
                                                       ...
                                                       list="questionsList"/>
                                                <span
                                                    className="input-group-text w_8rem justify-content-center">انتخاب سوال</span>
