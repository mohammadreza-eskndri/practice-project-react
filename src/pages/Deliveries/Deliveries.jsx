import AddDeliveries from "./AddDeliveries.jsx";
                ...
                <div className="row justify-content-between">
                    ...
                    <div className="col-2 col-md-6 col-lg-4 d-flex flex-column align-items-end">
                        <button className="btn btn-success d-flex justify-content-center align-items-center"
                                data-bs-toggle="modal" data-bs-target="#add_delivery_modal">
                ...
                <table className="table table-responsive text-center table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <i className="fas fa-times text-danger mx-1 hoverable_text pointer has_tooltip" title="حذف "
